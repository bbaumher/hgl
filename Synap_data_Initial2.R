...
Synap_raw <- read.csv("./Synap_SAT_1.csv", header = FALSE, stringsAsFactors = FALSE)
...
write.csv(student_info, file = "./student_info.csv")
...
write.csv(full_comb, file = "./full_comb.csv")
